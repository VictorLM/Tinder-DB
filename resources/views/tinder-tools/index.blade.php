                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center actions-div">
                                            <a class="float-left pass" id="{{$profile->tinder_id}}" data-link="{{$profile->tinder_id}}"><i class="fas fa-times-circle fa-3x action-icon" style="color:red;" title="Passar"></i></a>
